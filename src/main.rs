fn custom_logic_process(a: u8, b: u8) -> u8 {
...
fn main() {
    let input_a: u8 = 0b1010_1010; 
    let input_b: u8 = 0b0111_0101;
    
    let result = custom_logic_process(input_a, input_b);

    println!("输入 A: {:08b}", input_a);
    println!("输入 B: {:08b}", input_b);
    println!("结果  : {:08b}", result);
}