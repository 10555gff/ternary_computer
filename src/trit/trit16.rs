...
impl Trit16 {
    ...
    pub fn tnor(self, other: Self) -> Self {
        ...
        let res=((and & 0xAAAA_AAAA) >> 1) | ((or & 0x5555_5555) << 1);
        Trit16(res)
    }
    ...
    pub fn tnand(self, other: Self) -> Self {
        let or  = self.0 | other.0;
        let and = self.0 & other.0;
        let res=((or & 0xAAAA_AAAA) >> 1) | ((and & 0x5555_5555) << 1);
        Trit16(res)
    }
    ...
    pub fn tsum(self, other: Self) -> Self {
        let and = self.0 & other.0;
        let res = self.0 ^ other.0 ^ (((and & 0x5555_5555) << 1) | ((and & 0xAAAA_AAAA) >> 1));
        Trit16(res ^ (((res & (res >> 1)) & 0x5555_5555) * 3))
    }
